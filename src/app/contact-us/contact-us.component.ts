...
export class ContactUsComponent {
  ...
  get first_name() {
    return this.contactUs.get('first_name');
  }
  get last_name() {
    return this.contactUs.get('last_name');
  }
  get phone_number() {
    return this.contactUs.get('phone_number');
  }
  get country() {
  ...
  contactUsForm() {
    this.loading = true;
    this.contactUsService.contactUs(this.contactUs.value).subscribe({
      next: (data) => {
        this.loading = false;
